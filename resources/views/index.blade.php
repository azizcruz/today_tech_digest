                    ...
                    @foreach ($digests as $digest)
                        @if ($loop->last && isset($paginationLinks))
                            @if ($paginationLinks->next_page_url)
                                <div
                                    hx-get="{{ $paginationLinks->next_page_url ? str_replace('http', 'https', $paginationLinks->next_page_url) : '' }}&infinite_scroll=1{{ isset($activeCategory) ? '&category=' . $activeCategory . '' : '' }}"
