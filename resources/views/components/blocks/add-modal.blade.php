    ...
    <section id="add-digest-wrapper">
        ...
        >
            ...
            <div class="modal-box relative">
                ...
                <form
                    id="add-digest-form"
                    hx-post="{{ route('digest.store') }}"
                    x-data="{ title: '' }"
                    hx-target="#add-digest-wrapper"
                    hx-swap="outerHTML"
                ...
                >
                    ...
                    <input
                        ...
                        x-model="title"
                    />
                    <label class="label text-red-500 flex">
                    ...
                    <input
                        ...
                        class="input input-bordered w-full max-w-full"
                        value="{{ $oldInput['metaDescription'] ?? '' }}"
                    />
