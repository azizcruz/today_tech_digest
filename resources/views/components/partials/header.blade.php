<div class="navbar bg-base-300 mb-3">
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="0"
                ...
                <li>
                    <a href="{{ route('digest.today') }}" class="font-bold md:hidden normal-case flex-shrink">Today's
                        Digests</a>
                </li>
                <div class="divider md:hidden"></div>
                <li><a class="flex-grow flex-shrink" href="{{ route('about-us') }}">About us</a></li>
                <li><a class="flex-grow flex-shrink" href="{{ route('contact-us') }}">Contact</a></li>
                <li><a class="flex-grow flex-shrink" href="{{ route('privacy-policy') }}">Privacy Policy</a>
                </li>
                <li><a class="flex-grow flex-shrink" href="{{ route('terms-and-conditions') }}">Terms &
                        Conditions</a>
                </li>
    ...
    <div class="navbar-center">
        <a href="{{ route('home') }}" class="normal-case text-xl mr-4">
