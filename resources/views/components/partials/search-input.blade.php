<section class="my-container my-4 flex">
    <input type="search" placeholder="Search..." name="search" autocomplete="off" value=""
        ...
        hx-post="{{ route('search-digests') }}" hx-trigger="keyup changed delay:500ms, search" hx-target="#digests-list"
        hx-indicator=".htmx-indicator" hx-include-credentials hx-swap="outerHTML"
